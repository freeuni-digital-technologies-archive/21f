...
<!--
- სამშაბათს, 23 ნოემბერს, 14:00-ზე ზუმში იქნება შეხვედრა ჩემთან და გიგისთან ერთად რომ ახალი დავალების შესახებ მოვაგროვოთ ტექნიკური პრობლემები, კითხვები და უბრალოდ კომენტარები. რეგისტრაციის შემდეგ 10-15 სტუდენტს ავარჩევთ და დილით გამოგიგზავნით შეხვედრის ლინკს მეილზე. მონაწილეობისთვის მიიღებთ ბონუს 1 ქულას. [რეგისტრაცია](https://forms.gle/UkgsjQGaVgdJ2ePz8)
 -->
...
- სემინარი 
	- აპლიკაციების მაგალითები: [არჩევნების იმპლემენტაცია](https://github.com/freeuni-digital-technologies/application_examples/tree/main/elections) (დავასრულებთ მომავალ კვირას)

- დავალება 7 - html/css/js გამოქვეყნდება კვირის ბოლოს

#### მნიშვნელოვანი ინფორმაცია:
	
- **ბონუს თემის** შეთანხმების ბოლო თარიღია **27 დეკემბერი**. ამ კვირიდან აუცილებელია ბონუს თემა გააკეთოს **მინიმუმ სამმა** და **მაქსიმუმ ოთხმა** სტუდენტმა. ამ კვირას არის რამდენიმე თემა რომელსაც შეგიძლიათ შეუერთდეთ - [დოკუმენტი](https://docs.google.com/document/d/1JTjtYmX265xOrWSzaq9Ozg8gSqrArGIjAE5XBIahMmc/edit?usp=sharing). ამ კვირისთვის სხვა თემები აღარ მიიღება. მომავალი კვირისთვის შეგიძლიათ გამესაუბროთ/გუნდელები იპოვოთ ორშაბათს სემინარის შემდეგ.
