...
### მნიშვნელოვანი ინფორმაცია
მე 10 იანვრამდე ვისვენებ და მეილს არ შევამოწმებ. სოციალურ ქსელებში უნივერსიტეტის საკითხებზე დაკონტაქტება (მარტო ამ პერიოდში არა, ზოგადად) კატეგორიულად მიუღებელია. 


10-დან 17 იანვრამდე მიიღებთ
- ბოლო კვირების ზოგიერთი ლექციების/სემინარების ნოუთებს და ჩანაწერებს
- პროექტის შესახებ ინფორმაციას
...
- ბონუს ქულები:
	+ თემა - 5 ქულა
		ბონუს თემის შეთანხმება შეგიძლიათ **10 იანვრის** სემინარის შემდეგ (ონლაინ ან პირადად). **სხვა შესაძლებლობა აღარ იქნება**. მეილზე თემის შეთანხმება **არ ხდება**
	- ინფორმაციას და დეტალებს მიიღებთ შეთანხმების შემდეგ. აუცილებელია ჯგუფში იყოს 3 ან 4 სტუდენტი. თემის შეთანხმებამდე იდეებისთვის გამოიყენეთ "ბონუს დისკუსიის/პრეზენტაციის თემები" რომელიც დამატებულია "ინფორმაცია,რესურსებ"-ში ან შეარჩიეთ რამე ლექციებიდან/დისკუსიებიდან
	+ დისკუსია - 5 ქულა ონლაინ ჯგუფში და აუდიტორიის დისკუსიებში აქტიურობისთვის.
	+ სხვა - ლექციის/სემინარის დროს ვამბობ ხოლმე პატარა დავალებებს რომლის შესრულების შემთხვევაში ვწერ ბონუს ქულას
...
### 15. 10 იანვარი
- ლექცია - დაშიფვრა. ციფრული უსაფრთხოება
